      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 reveal-stagger mb-10 md:mb-14">
          {servicos.map((s, i) => (
            <div
              key={i}
              className="group relative rounded-xl p-5 md:p-6 border transition-all duration-300 hover:-translate-y-1"
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <span
                  className="font-orbitron text-xs font-bold px-2 py-1 rounded-md"
                  style={{
        ...
        <div className="reveal">
          <div
            className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-5 rounded-xl border"
            style={{
          ...
          >
            ...
            <a
              ...
              style={{
                ...
                boxShadow: "0 0 20px rgba(14,179,255,0.3)",
              }}
            >
              AGENDAR DIAGNÓSTICO →
            </a>
