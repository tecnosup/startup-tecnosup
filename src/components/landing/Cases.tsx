    ...
    <section id="cases" className="relative z-10 py-20 md:py-28 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16 reveal">
          <p className="font-orbitron text-[10px] md:text-xs tracking-[0.3em] text-[#0eb3ff] mb-3">CASES</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {cases.map((c, i) => (
            <div
              key={i}
              className="reveal group relative rounded-xl border overflow-hidden transition-all duration-300 hover:-translate-y-1"
